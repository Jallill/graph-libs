...
Shader "VortexShield"
{
	Properties
	{
		...
		_Intensity("Intensity", Float) = 1.52
		_Noiseintensity("Noise intensity", Float) = 0.6
		[HDR]_VortexTint("Vortex Tint", Color) = (0,2.118547,2.118547,0)
	...
	SubShader
	{
		...
		{
			float4 appendResult8 = (float4(_RotationSpeed , 0.0 , 0.0 , 0.0));
			float4 appendResult45 = (float4(1.0 , _Tiling , 0.0 , 0.0));
			float2 uv_TexCoord10 = i.uv_texcoord * appendResult45.xy;
			float2 panner34 = ( 1.0 * _Time.y * appendResult8.xy + uv_TexCoord10);
			float simplePerlin2D2 = snoise( panner34*_NoiseScale );
			simplePerlin2D2 = simplePerlin2D2*0.5 + 0.5;
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float lerpResult47 = lerp( step( _Noiseintensity , simplePerlin2D2 ) , 0.0 , ase_vertex3Pos.y);
			float temp_output_49_0 = pow( ( lerpResult47 / _Intensity ) , _Falloff );
			o.Albedo = ( _VortexTint * temp_output_49_0 ).rgb;
...
/*ASEBEGIN
Version=18900
0;584;1360;455;2121.351;130.7444;1.284888;True;False
Node;AmplifyShaderEditor.RangedFloatNode;44;-2072.423,-131.4039;Inherit;False;Property;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;15;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1797.259,73.96564;Inherit;False;Property;_RotationSpeed;Rotation Speed;6;0;Create;True;0;0;0;False;0;False;0.4;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-1273.416,182.6165;Inherit;False;Property;_NoiseScale;Noise Scale;1;0;Create;True;0;0;0;False;0;False;8;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-913.9153,-143.4638;Inherit;False;Property;_Noiseintensity;Noise intensity;4;0;Create;True;0;0;0;False;0;False;0.6;0.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-398.4409,90.9984;Inherit;False;Property;_Intensity;Intensity;3;0;Create;True;0;0;0;False;0;False;1.52;1.52;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-194.291,111.135;Inherit;False;Property;_Falloff;Falloff;2;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;20;-614.5414,-532.4505;Inherit;False;Property;_VortexTint;Vortex Tint;5;1;[HDR];Create;True;0;0;0;False;0;False;0,2.118547,2.118547,0;0,2.118547,2.118547,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C1215102C430C67ED4A7C43EDA95717644C78E6C